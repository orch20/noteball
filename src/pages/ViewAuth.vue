<template>
    <div class="auth">
        <div class="tabs is-centered">
            <ul>
                <li :class="{ 'is-active': !registerLoginToggle }">
                    <a @click.prevent="registerLoginToggle = false">Login</a>
                </li>
                <li :class="{ 'is-active': registerLoginToggle }">
                    <a @click.prevent="registerLoginToggle = true">Register</a>
                </li>
            </ul>
        </div>
...
const formTitle = computed(() => {
    return registerLoginToggle.value ? 'Register' : 'Login'
})
